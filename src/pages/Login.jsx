...
export default function Login() {
  ...
  async function onCredentialsSubmit(e) {
    ...
    // Credentials are valid. Gate access on the image captcha next.
      ...
      <div className="mx-auto flex min-h-screen max-w-xl flex-col items-center px-6 pt-10 pb-16">
        ...
        <h1 className="font-display mt-3 text-4xl font-extrabold text-navy-ink">
          {stage === 'credentials'
            ...
            : <>One more check<span className="text-brandred">|</span></>}
        </h1>
        ...
        <div className="mt-6 flex items-center gap-4">
          ...
          <div className="speech-bubble text-sm">
            {stage === 'credentials'
              ? <>Sign in. Be seen.<span className="text-brandred">|</span></>
              : <>Prove you're human. Then you're in.</>}
          </div>
        </div>

        {/* STAGE 1 — credentials */}
        {stage === 'credentials' && (
          <form onSubmit={onCredentialsSubmit} className="card-light mt-6 w-full p-6 sm:p-8">
            <div className="mb-4">
        ...
        {/* STAGE 2 — image verification (real photos) */}
        {stage === 'image_verify' && (
