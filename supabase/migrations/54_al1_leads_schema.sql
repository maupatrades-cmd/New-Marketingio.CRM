...
ALTER TABLE leads
  ...
  ADD COLUMN IF NOT EXISTS estimated_value_zar numeric(12,2);
...
BEGIN
  ...
  WITH filtered AS (
    SELECT
      l.id, l.business_name, l.contact_name, l.phone, l.email,
    ...
    WHERE
      (p_search IS NULL OR (
        ...
        l.contact_name  ILIKE '%' || p_search || '%' OR
